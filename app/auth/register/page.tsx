      ...
      >
        <div className="rounded-3xl border border-white/40 bg-white/80 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <p className="text-center text-[#222222]/70 mb-8">
            Start your gentle wellness journey today
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#174D3A] mb-2">
                Name
              </label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-[#174D3A]/50" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#174D3A] mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <CheckCircle className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-[#174D3A]/50" />
                <input
                  id="confirmPassword"
                  type="password"
          ...
          <div className="mt-6 text-center text-sm text-[#222222]/70">
            ...
            <Link href="/auth/login" className="font-semibold text-[#174D3A] hover:underline">
              Sign in
            </Link>
          </div>
        </div>
