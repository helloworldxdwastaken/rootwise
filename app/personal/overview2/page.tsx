...
export default function PersonalOverviewV2Page() {
          ...
          <StripCard title="Weekly patterns">
            <div className="mt-1 flex items-center justify-between gap-4">
              <div className="flex flex-col gap-1">
                <p className="text-sm font-semibold text-slate-800">Aver t week</p>
                <p className="text-sm text-slate-500">Past week</p>
...
function WeeklyChart() {
  return (
    <svg viewBox="0 0 160 80" className="h-24 w-full text-slate-300">
      <path
        d="M0 65 C 20 60 30 45 45 42 C 65 37 80 60 95 58 C 112 56 125 43 140 46 C 150 48 155 52 160 50"
        stroke="#90b4b2"
        strokeWidth="3"
        fill="none"
      />
      <path
        d="M0 70 C 20 60 30 45 45 42 C 65 37 80 60 95 58 C 112 56 125 43 140 46 C 150 48 155 52 160 50 L160 80 L0 80 Z"
        fill="#dcefee"
        fillOpacity="0.7"
      />
    </svg>
